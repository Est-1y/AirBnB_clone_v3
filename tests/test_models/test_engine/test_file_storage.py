...
class TestFileStorageDocs(unittest.TestCase):
    """checking documentation and style of FileStorage class"""
    @classmethod
    def setUpClass(cls):
        """doc tests"""
...
test_file_storage.py'])
    ...
    def test_fs_func_docstrings(self):
        """docstrings in FileStorage methods"""
...
class TestFileStorage(unittest.TestCase):
    ...
    def test_all_returns_dict(self):
        """returning the FileStorage.__objects attribute"""
        storage = FileStorage()
    ...
    @unittest.skipIf(models.storage_t == 'db', "not testing file storage")
    def test_new(self):
        """adding an object to the FileStorage.__objects attribute."""
        storage = FileStorage()
    ...
    @unittest.skipIf(models.storage_t == 'db', "not testing file storage")
    def test_count(self):
        """Tests count method functionality"""
